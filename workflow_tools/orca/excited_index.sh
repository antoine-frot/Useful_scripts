...
index_label="A B 1 2 3 4 11 12 13 14 15 16 20 21"
...
do
	...
	if [ $Index_Type = A ] ; then
		...
		do
        		...
        		echo "               - Change Grid Size : 13"
        		echo "               - Auto-Save of CUBE-file : 14"
        		echo "               - Change the cutoff : 15"
			echo "               - Name of the Tozer file : 16"
        		echo ""
        		echo "               - Change the code : 20"
			echo "               - Exit : 21"
        		echo "    --------------------------------------------------------------"
...
EOF
				...
				rm transition.txt
                		...
                		mv Tozer.txt Tozer_state_${State_Index}.txt
				if [ -n "$name" ]; then
